...
- Добавление трёх новых столбцов в вкладку "СК ТПХ_1 пг":
  ...
  - **Квартал приобретения:**  Определяет квартал, к которому относится дата приобретения (Q1, Q2, Q3, Q4).
  - **Рассчитанная себестоимость:**  Содержит значение прямой себестоимости, подтянутое из справочной вкладки.
