...
2. **"Квартал приобретения"** - определённый на основе даты квартал (в формате "N квартал YYYY")
3. **"Стоимость закупки НЧТЗ 1 ед"** - значение из столбца AQ справочной вкладки
4. **"Прямая СС НЧТЗ 1 ед"** - значение из столбца AR справочной вкладки
5. **"НР НЧТЗ 1 ед"** - значение из столбца AS справочной вкладки

### Возможные значения в новых столбцах:
- Числовое значение - успешно сопоставленные данные
